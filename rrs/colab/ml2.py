...
def plotCityRatings(subset_business):
    # peak the tables
...
def produceFinalDataFrame(rest, df_attr_dummies):
...
def dataPreprocessing():
    ...
    df_final = produceFinalDataFrame(rest, df_attr_dummies)
    return rest, subset_review, df_final
...
def contentBasedFiltering(df_final):
