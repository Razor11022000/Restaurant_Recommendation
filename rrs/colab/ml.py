...
# # test set from the df_final table (only last row): Restaurant name: "Adelita Taqueria & Restaurant"
...
# # distances and indeces from validation set (Adelita Taqueria & Restaurant)
# distances, indeces =  n_knn.kneighbors(test_set)
# #n_knn.kneighbors(test_set)[1][0]

# # create table distances and indeces from "Adelita Taqueria & Restaurant"
...
# # get names of the restaurant that similar to the "Adelita Taqueria & Restaurant"
